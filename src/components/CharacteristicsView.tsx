      ...
      <div className="grid grid-cols-[repeat(5,max-content)] justify-center gap-x-[max(0px,min(1.5rem,calc((100%-280px)/4)))] gap-y-6 md:grid-cols-[repeat(10,max-content)] md:gap-x-4">
        {(UI_LABELS.CHARACTERISTICS as Characteristic[]).map((characteristic) => {
          ...
          return (
            ...
            >
              <span className="mb-1 wfrp-label tracking-tighter text-wfrp-muted-text transition-colors group-hover/char:text-wfrp-gold lg:mb-1.5 lg:text-[11px]">
              ...
              <div className="relative">
                ...
                >
                  <div className="text-xl font-semibold tracking-tight transition-colors group-hover/char:text-wfrp-gold lg:text-3xl">
                    {value}
                  </div>
                  ...
                  <div className="absolute -bottom-1.5 left-1/2 z-10 flex h-7 w-7 -translate-x-1/2 items-center justify-center rounded-full border-2 border-wfrp-border bg-wfrp-surface transition-colors group-hover/char:border-wfrp-gold/60 lg:-bottom-2 lg:h-8 lg:w-8">
                    <span className="text-[10px] font-semibold text-wfrp-muted-text group-hover/char:text-wfrp-gold/60 lg:text-[11px]">
                      {bonus}
                    </span>
                  </div>
                </button>
