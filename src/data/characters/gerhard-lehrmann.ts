...
export const gerhardLehrmann: CharacterRecord = {
  ...
  skills: [
    ...
    { skillId: "skill_melee", specialisationId: "melee_basic", advances: 5 },
    { skillId: "skill_perception", advances: 10 },
    { skillId: "skill_lore", specialisationId: "lore_engineering", advances: 7 },
    { skillId: "skill_language", specialisationId: "language_magick", advances: 4 },
    { skillId: "skill_trade", specialisationId: "trade_engineer", advances: 10 },
    { skillId: "skill_language", specialisationId: "language_classical", advances: 3 },
    { skillId: "skill_trade", specialisationId: "trade_gunsmith", advances: 2 },
    { skillId: "skill_evaluate", advances: 2 },
    { skillId: "skill_trade", specialisationId: "trade_apothecary", advances: 5 },
    { skillId: "skill_ranged", specialisationId: "ranged_blackpowder", advances: 5 },
    { skillId: "skill_research", advances: 2 },
    { skillId: "skill_navigation", advances: 2 },
    { skillId: "skill_language", specialisationId: "language_guilder", advances: 2 },
  ],
  equipment: [
