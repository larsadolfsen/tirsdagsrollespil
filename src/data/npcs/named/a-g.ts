...
export const namedNpcsAG: NpcTemplate[] = [
  ...
  },
  {
    ...
    name: "Donna",
    isNpc: true,
    description: "Kind and generous cook, worn down by lack of appreciation. More likely to talk a thief into fleeing than fight.",
    category: "human",
  ...
  },
  {
    ...
    name: "Ceparius",
    isNpc: true,
    description: "Cringing magician hireling. Strange-smelling, evasive, and afraid of almost everything, especially Salmo.",
    category: "human",
    group: "K6: The Great Mansion Heist",
    tags: [
      "One Session Kits",
