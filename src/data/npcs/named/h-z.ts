...
export const namedNpcsHZ: NpcTemplate[] = [
  ...
  },
  {
    ...
    isNpc: true,
    description: "Cold, calculating merchant-lord and local ruler. Greedy, cautious, and dangerous when his wealth or secrets are threatened.",
    category: "human",
  ...
  },
  {
    ...
    name: "Verner",
    isNpc: true,
    description: "Jumpy steward who wants to keep his position. Prone to panic and fumbles, but used to ignoring strange household noises.",
    category: "human",
    group: "K6: The Great Mansion Heist",
    tags: [
      "One Session Kits",
  ...
  },
  {
    ...
    name: "Orso",
    isNpc: true,
    description: "Accountant kept in service to maintain double books. Mutters to himself, thinks in numbers, and barely registers threats at first.",
    category: "human",
    group: "K6: The Great Mansion Heist",
    tags: [
      "One Session Kits",
  ...
  },
  {
    ...
    isNpc: true,
    description: "Intense cult priest and smooth public sermoniser. Fanatically devoted to secret rites, preferring converts but accepting sacrifices.",
    category: "human",
    group: "K6: The Great Mansion Heist",
    tags: [
      "One Session Kits",
