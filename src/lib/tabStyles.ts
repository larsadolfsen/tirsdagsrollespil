...
export const mobileTabButtonBaseClassName =
  "mx-3 flex h-11 w-[calc(100%-1.5rem)] cursor-pointer items-center rounded border px-4 text-left text-[12px] font-bold tracking-wide text-[var(--color-wfrp-muted-text)] transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-wfrp-gold/50";
