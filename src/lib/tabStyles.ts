...
export const inlineSubtabButtonInactiveClassName = "bg-[#242424] text-[var(--color-wfrp-muted-text)] group-hover:bg-white/10";
...
export const mobileTabButtonInactiveClassName = "border-transparent text-wfrp-muted-text hover:border-wfrp-border hover:bg-white/10";
