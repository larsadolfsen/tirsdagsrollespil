...
export const mainTabButtonInactiveClassName = "text-wfrp-muted-text hover:text-gray-200";
...
export const inlineSubtabButtonInactiveClassName = "bg-wfrp-border text-gray-300 group-hover:bg-wfrp-control-hover group-hover:text-white";
